...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    address_id: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_1: Schema.Attribute.String;
    date_2: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::address.address'
    ...
    town_location: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiGuildGuild extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    guild_id: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiInstrumentAdvertisedInstrumentAdvertised
  extends Struct.CollectionTypeSchema {
...
export interface ApiInstrumentKnownInstrumentKnown
  extends Struct.CollectionTypeSchema {
...
export interface ApiMakerMaker extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Historical instrument makers';
    displayName: 'Maker';
    pluralName: 'makers';
    singularName: 'maker';
  };
  ...
  attributes: {
    addresses: Schema.Attribute.Relation<'oneToMany', 'api::address.address'>;
    Adv_trade1: Schema.Attribute.Text;
    Adv_trade2: Schema.Attribute.Text;
    Alt_name: Schema.Attribute.String;
    Count_stat: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_1: Schema.Attribute.String;
    date_2: Schema.Attribute.String;
    Date1_qual: Schema.Attribute.String;
    Date2_qual: Schema.Attribute.String;
    disambiguated_relations: Schema.Attribute.Relation<
      'oneToMany',
      'api::disambiguated-relation.disambiguated-relation'
    >;
    first_name: Schema.Attribute.String;
    Guild: Schema.Attribute.String;
    guilds: Schema.Attribute.Relation<'oneToMany', 'api::guild.guild'>;
    instruments_advertised: Schema.Attribute.Relation<
      'oneToMany',
      'api::instrument-advertised.instrument-advertised'
    ...
    memberships: Schema.Attribute.Relation<
      ...
      'api::membership.membership'
    >;
    Mig_town: Schema.Attribute.String;
    misc_info_1: Schema.Attribute.Text;
    misc_info_2: Schema.Attribute.Text;
...
export interface ApiMembershipMembership extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A relationship between a maker and a guild';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entry_date_1: Schema.Attribute.Date;
    entry_date_2: Schema.Attribute.Date;
...
export interface ApiRelationRelation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Relationships between makers';
  ...
  attributes: {
    assigned_name: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 510;
      }>;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiSourcesSources extends Struct.CollectionTypeSchema {
  collectionName: 'sources';
  info: {
    description: 'Source information for makers';
    displayName: 'Sources';
    pluralName: 'sources-info';
    singularName: 'sources';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    directories: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 510;
      }>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    sources_key: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTownLocationTownLocation
  ...
  info: {
    displayName: 'Town Location';
    pluralName: 'town-locations';
    singularName: 'town-location';
  };
  options: {
    draftAndPublish: false;
  };
